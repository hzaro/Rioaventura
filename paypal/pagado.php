<?php
            ...
            <div style="text-align:center;width:-moz-fit-content;margin:0 auto;">
              ...
              <div style="margin:0 auto;text-align: left;">
                ...
                <ul style="color:#484848;font-size:16px;">
                  ...
                  <li style="margin-bottom:5px;max-width:600px;"><b>Comprado por panel: </b>No</li>
                  <li style="margin-bottom:5px;max-width:600px;"><b>Opción de Pago: </b> Paypal </li>
                  <li style="margin-bottom:5px;max-width:600px;"><b>Usuario: </b> Por Web </li>
                </ul>
              </div>
  ...
  $sql7="INSERT INTO pagos (id_compra, pagado_con_paypal, monto_dolares_paypal) VALUES (:id_compra,:pagado_paypal_si,:monto_dolares_paypal) ON DUPLICATE KEY UPDATE id_compra=:id_compra,pagado_con_paypal=:pagado_paypal_si,monto_dolares_paypal=:monto_dolares_paypal";
  ...
  $sth7->execute(array(
    ...
    ':monto_dolares_paypal'=>$_POST['monto_paypal'],
  ));
