                ...
                <form id="form_modalCompraWeb">
                            ...
                            <div class="row no-m-t no-m-b">
                                ...
                                <div class="col-xs-12 col-md-6 col-lg-4">
                                    <div class="input_container">
                                        ...
                                        <input id="fecha_paquete_web" type="text" class="form-control datetime" name="fecha" placeholder="dd / mm / aa" required>
                                    </div>
                                </div>                                                               
                                <!-- <div class="col s12 m6 l4"> -->
                                <div class="col-xs-12 col-md-6 col-lg-4">
                                    <div class="input_container transporting">
                    ...
                    <div class="row no-m-t no-m-b">
                        ...
                        <div class="col-xs-6">
                            ...
                            <h3></span>Total:  $<span id="total"></span></h3>
                        </div>
                        <!-- <div class="col s6 m6 l6" style="text-align: right;padding-top: 55px;"> -->
                        <div class="col-xs-6" style="text-align: right;padding-top: 55px;">
                            <button type="submit" href="#!" id="botonPagarWeb" class="btn btn btn-success waves-effect waves-green modal-trigger" href="#modalMetodoPago">
                                Comprar
                            </button> 
                        </div>
                    </div>
