function validar_ipage(){ 
        ...
        $.ajax({
          ...
          success:function(data, textStatus, jqXHR){            
            ...
            // $('#abreMetodo').click();
            $('#modalCompra').closeModal();
            $('#modalMetodoPago').openModal();
                    ...
                    return actions.payment.execute().then(function(payment) {
                      ...
                      $.ajax({
                          ...
                          .done(function( msg ) {
                            ...
                            // $('#modalMetodoPago').modal('toggle');
                            $('#modalMetodoPago').closeModal();
                      ...
                      $MPC.openCheckout({
                        ...
                        onreturn: function(json) {                    	
                          if (json.collection_status=='approved')
                          {
                            ...
                            setTimeout(window.location.replace("comprar_paquetes.php"), 3000);
                            // setTimeout();                    
                          }
